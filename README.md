...
- Guest Machine's IP
-   "      "      Hostname, accessible in your host's browser
- The primary application folder and nested public folder
...
3_local-vagrant-bootstrap.php (after removing the .sample suffix),
this file will be skipped if not found.
